...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForumModel&&(identical(other.forumId, forumId) || other.forumId == forumId)&&(identical(other.relatedGameId, relatedGameId) || other.relatedGameId == relatedGameId)&&const DeepCollectionEquality().equals(other.postsId, postsId));
}
...
@override
String toString() {
  return 'ForumModel(forumId: $forumId, relatedGameId: $relatedGameId, postsId: $postsId)';
}
...
class _ForumModel implements ForumModel {
  const _ForumModel({required this.forumId, required this.relatedGameId, final  List<String>? postsId}): _postsId = postsId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ForumModel&&(identical(other.forumId, forumId) || other.forumId == forumId)&&(identical(other.relatedGameId, relatedGameId) || other.relatedGameId == relatedGameId)&&const DeepCollectionEquality().equals(other._postsId, _postsId));
}
