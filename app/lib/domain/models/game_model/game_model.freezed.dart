...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,gameId,publisherId,name,description,briefDescription,requirement,price,recommended,releaseDate,const DeepCollectionEquality().hash(categories),const DeepCollectionEquality().hash(media),headerImage,requestStatus,isSale,discountPercent,saleStartDate,saleEndDate,path,const DeepCollectionEquality().hash(binaries),const DeepCollectionEquality().hash(exes),isOwned,downloadState,isInWishlist,playtimeHours]);
